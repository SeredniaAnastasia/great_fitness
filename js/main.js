...
/* harmony import */ var _functions_my_validate_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/my-validate-form */ "./src/js/functions/my-validate-form.js");
/* harmony import */ var _functions_my_validate_form__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_functions_my_validate_form__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _functions_setting__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/setting */ "./src/js/functions/setting.js");
/* harmony import */ var _functions_setting__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_functions_setting__WEBPACK_IMPORTED_MODULE_4__);
...
/***/ "./src/js/functions/my-validate-form.js":
/*!**********************************************!*\
  !*** ./src/js/functions/my-validate-form.js ***!
  \**********************************************/
/***/ (() => {
...
const submit = myForm => {
  ...
  fetch(mailPathUrl, dataFetch).then(response => response.json()).then(result => {
...
myForm?.addEventListener('submit', async event => {
  ...
  if (captcha === '') {
    ...
    if (result.success) {
      if (nameError.textContent === '' && emailError.textContent === '' && telError.textContent === '' && themeError.textContent === '' && form_textError.textContent === '' && checkedError.textContent === '') {
        console.log("send");
        submit(event.target);
      }
      captchaError.textContent = '';
...
/***/ "./src/js/myFunction/myFunction.js":
/*!*****************************************!*\
  !*** ./src/js/myFunction/myFunction.js ***!
  \*****************************************/
/***/ (() => {
...
/* harmony import */ var _myFunction_myFunction__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./myFunction/myFunction */ "./src/js/myFunction/myFunction.js");
/* harmony import */ var _myFunction_myFunction__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_myFunction_myFunction__WEBPACK_IMPORTED_MODULE_4__);
